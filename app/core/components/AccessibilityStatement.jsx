      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          ...
          <p className="govuk-body">
            We want everyone to be able to get and do what they need with this
            service, regardless of access needs, due to a disability or
            condition.
          </p>
          <p className="govuk-body">
          ...
          <p className="govuk-body">
            This website is run by Border Force. We want as many people as
          ...
          <p className="govuk-body">
            As part of providing this service, we may need to send you messages
            or documents. Tell us how you want us to send messages or documents
            to you. Tell us if you need them in a different format, for example
            large print, audio recording or braille.
          </p>
          <p className="govuk-body">
            We’re always looking to improve the accessibility of our websites
            and services. If you find any problems or think we’re not meeting
            accessibility requirements, use the contact details above (in
          ...
          <ul className="govuk-list govuk-list--bullet">
            ...
            <li>
              ...
              elements other than list items within a set of list elements so
              screen readers cannot inform the listener that they are listening
            ...
            <li>
              Keyboard (2.1.1) – With drop down lists that contain the “type to
              search” function, users are unable to scroll through the drop down
              list and then go back to the “type to search” function.
            </li>
            <li>
            ...
            <li>
              Keyboard trap (2.1.2) – When the user has JAWS running in the
              background, the focus of the selected option can get stuck in the
              drop down list.
            </li>
            <li>
          ...
          <p className="govuk-body">
            Our plan below describes how and when we plan to improve the
            accessibility of this service:
          </p>
          <ul className="govuk-list govuk-list--bullet">
            <li>We will train our staff to create accessible services.</li>
            <li>
              We will implement automated and manual accessibility testing in
              our development process.
            </li>
            <li>
              We will conduct user research and testing with users who have
              access needs.
            </li>
            <li>
              We will put in place alternative arrangements for those who need
              them and be willing to make additional adjustments if these are
              not enough.
            </li>
          </ul>

          <p className="govuk-body">
            We plan to identify and fix the following areas to be fully
          ...
          <ul className="govuk-list govuk-list--bullet">
            ...
            <li>
              (2.1.1) – Ensure users are able to scroll up to the “type to
              search” function in drop down lists.
            </li>
            <li>
            ...
            <li>
              (2.1.2) – Ensure the user that the focus of the selected option
              does not get stuck in the drop down list when JAWS is running in
              the background.
            </li>
          ...
          <p className="govuk-body">
            ...
            cover both new forms—Record Trade Checks and PCP Desk Ergonomic
          ...
          <p className="govuk-body">
            ...
            be making changes due to descoping this form soon, if you need any
            help with this form please contact us (please see feedback and
          ...
          <p className="govuk-body">
            Some forms on COP will send a PDF to your email or require you to
            generate a PDF, these are essential to providing our services.
          </p>
          <p className="govuk-body">
          ...
          <p className="govuk-body">
            ...
            reviewed on 20 January 2021.
          </p>
          <p className="govuk-body">
            This website was last tested on 20 January 2021. The test was
