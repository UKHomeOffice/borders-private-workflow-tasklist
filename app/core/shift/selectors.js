...
export const submittingActiveShift = state =>
  state[NAME].get('submittingActiveShift');
export const activeShiftSuccess = state =>
  state[NAME].get('activeShiftSuccess');
...
export const failedToCreateShift = state =>
  state[NAME].get('failedToCreateShift');
